...
designing this aspect are:

* Able to easily mandate login for commands already implemented
* Able to easily mandate login for future commands
* Able to easily disable compulsory login for commands

* **Alternative 1 (current choice):** Do the check in `LogInManager`
