...
image::AddCommand-activity-diagram.png[width="800"]
...
`LogInManager` module manages sign-in module.
#isSignedIn
#signIn
#signOut
#resetUndoRedoHistory

`JsonPasswordsStorage` module manages reading of passwords (only at
initialisation of Main App).
