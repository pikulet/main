...
** Cons:
*** Difficult to check which methods require sign-in. Every method, instead
 of implementing a boolean check on `requiresSignIn()`, indicates if it
 requires sign-in using a call to a method in the superclass.
