...
[TIP]
Access my contributed code https://nus-cs2103-ay1819s1.github
 .io/cs2103-dashboard/#=undefined&search=pikulet[here].
...
parameters], namely the
 room and date details) in a hotel booking. Note that the actual `Room` and
 `Booking` packages were not done by me.
* https://github.com/CS2103-AY1819S1-F11-2/main/pull/162[Modified the `clear`
command] to maintain empty hotel rooms. Added function for GUI verification
of rooms.
