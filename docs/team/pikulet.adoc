...
* Modified the `add` command to https://github
.com/CS2103-AY1819S1-F11-2/main/pull/104[take in more parameters], namely the
...
command] to maintain empty hotel rooms. Previously, `clear` removed all data.
