...
*** Added Coveralls, Appveyor, and Codacy support for team repo
...
**** Did cosmetic tweaks to existing contents of the User Guide: https://github.com/CS2103-AY1819S1-F11-2/main/pull/238[#238]
...
** Community
*** PRs reviewed (with non-trivial review comments), giving praise and encouragement where it is due:
