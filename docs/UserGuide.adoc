...
==== Adding a new account
 ...
 Currently, Concierge does not have a feature for users to add an account via the app. The reason is because we only read from the password file. Nevertheless, for the adventurous users who want to create their own accounts, this sub-section will be useful.
