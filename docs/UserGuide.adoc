...
[cols="^.^,<.^9a", frame=none]
|===
|image:icon-key.png[Login requirement,640,480,pdfwidth=50%,scaledwidth=50%]
|This is a `login` icon. If a command requires login before execution, this icon will be located on its right in its title.
|===

[cols="^.^,<.^9a", frame=none]
|===
|image:icon-important.png[Important info,640,480,pdfwidth=50%,scaledwidth=50%]
...
// tag::add[]
=== Adding a guest: `add` image:icon-key.png[width="30"]
...
[cols="^.^,<.^9a", frame=none]
|===
|image:icon-important.png[width="50"]
|
...
//tag::checkin[]
=== Check-in room: `checkin` image:icon-key.png[width="30"]
...
//tag::checkout[]
=== Checkout room: `checkout` image:icon-key.png[width="30"]
...
//tag::reassign[]
=== Reassigning a guest to another room : `reassign` image:icon-key.png[width="30"]
...
=== Provide Room Service: `service` image:icon-key.png[width="30"]
...
// tag::clear[]
=== Clearing all entries : `clear` image:icon-key.png[width="30"]
